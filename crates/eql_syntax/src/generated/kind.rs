...
impl EqlSyntaxKind {
  pub const fn is_punct(self) -> bool {
    match self {
      ...
      | MODULO | POW | LESS | GREATER | EQUAL | AMPERSAND | PIPE | AT | DOLLAR => true,
      _ => false,
    }
  }
